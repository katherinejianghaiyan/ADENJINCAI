...
namespace Luoyi.Web
{
    public partial class Coupon : PageBase
    {
        ...
        protected void Bind()
        {
            ...
            var listUserCoupon = BLL.UserCoupon.GetList(_UserInfo.UserID, _UserInfo.BUGUID, cartTotalAmount);
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                LinkButton lbtnCoupon = e.Item.FindControl("lbtnCoupon") as LinkButton;
                var info = e.Item.DataItem as UserCouponInfo;
                var couponInfo = CouponHelper.GetCoupon();
                if (!active && couponInfo != null && couponInfo.ID == info.ID)
                {
                    lbtnCoupon.CssClass = "couponBlock active";
                    active = true;
                }
                else
                {
                    lbtnCoupon.CssClass = "couponBlock";
                }
            }
        }
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                var info = BLL.UserCoupon.GetInfo(e.CommandArgument.ToString().ToInt32());

                if (info != null)
                {
                    CouponHelper.RememberCoupon(info);
