...
{
    public partial class AlipayReturn : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (sPara.Count > 0)//判断是否有带返回参数
            {
                ...
                if (verifyResult)//验证成功
                {
                    ...
                    {
                        Logger.Info("aliayreturn 【" + out_trade_no + "】");
                    ...
                    //打印页面
                    JavaScriptHelper.Show("支付成功", "/account/", JavaScriptHelper.TargetEnum.top);
