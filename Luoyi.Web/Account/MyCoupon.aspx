<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/Default.Master" AutoEventWireup="true" CodeBehind="MyCoupon.aspx.cs" Inherits="Luoyi.Web.Account.MyCoupon" %>
    ...
    <section>
        ...
        <div class="couponList">
            ...
            <asp:Repeater ID="rptList" runat="server">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnCoupon" runat="server" CssClass="couponBlock active" Enabled="false">
