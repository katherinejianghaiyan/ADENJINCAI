...
namespace Senparc.Weixin.MP.Sample.CommonService.CustomMessageHandler
{
    ...
    public partial class CustomMessageHandler : MessageHandler<CustomMessageContext>
    {
        ...
        private string agentUrl = WebConfigurationManager.AppSettings["WeChatAgentUrl"];//这里使用了www.weiweihi.com微信自动托管平台
        private string agentToken = WebConfigurationManager.AppSettings["WeChatToken"];//Token
        private string wiweihiKey = WebConfigurationManager.AppSettings["WeChatEncodingAESKey"];//WeiweihiKey专门用于对接www.Weiweihi.com平台，获取方式见：http://www.weiweihi.com/ApiDocuments/Item/25#51

        private string appId = WebConfigurationManager.AppSettings["WeChatAppID"];
        private string appSecret = WebConfigurationManager.AppSettings["WeChatAppSecret"];
...
测试完成后，您可以登陆公众号后台取消授权。",
            ...
            else
            {
                ...
                result.AppendFormat("<a href=\"{0}\">净菜</a>", "http://weixin.luoyitech.com");
